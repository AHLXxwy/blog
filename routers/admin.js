...
var User = require('../model/User');//用户模型
var Category = require('../model/Category');//分类模型
var Content = require('../model/Content');//内容模型
//
...
routerAdmin.get('/user', function (req, res, next) {
    ...
    var pages = Number((req.query.page) === undefined ? 0 : req.query.page);
    // console.log(pages);
    var page = pages <= 0 ? 1 : pages;
    var limit = 4;
    var pages = 0;
